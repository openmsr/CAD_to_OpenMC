...
#40 = VERTEX_POINT('',#41);
#41 = CARTESIAN_POINT('',(0.,8.,16.));
#42 = LINE('',#43,#44);
#43 = CARTESIAN_POINT('',(0.,8.,0.));
#44 = VECTOR('',#45,1.);
#45 = DIRECTION('',(0.,0.,1.));
#46 = ORIENTED_EDGE('',*,*,#47,.F.);
#47 = EDGE_CURVE('',#24,#40,#48,.T.);
#48 = LINE('',#49,#50);
#49 = CARTESIAN_POINT('',(0.,0.,16.));
#50 = VECTOR('',#51,1.);
#51 = DIRECTION('',(-0.,1.,0.));
#52 = PLANE('',#53);
...
#80 = VERTEX_POINT('',#81);
#81 = CARTESIAN_POINT('',(4.,8.,16.));
#82 = LINE('',#83,#84);
#83 = CARTESIAN_POINT('',(4.,8.,0.));
#84 = VECTOR('',#85,1.);
#85 = DIRECTION('',(0.,0.,1.));
#86 = ORIENTED_EDGE('',*,*,#87,.F.);
#87 = EDGE_CURVE('',#64,#80,#88,.T.);
#88 = LINE('',#89,#90);
#89 = CARTESIAN_POINT('',(4.,0.,16.));
#90 = VECTOR('',#91,1.);
#91 = DIRECTION('',(-0.,1.,0.));
#92 = PLANE('',#93);
...
#131 = LINE('',#132,#133);
#132 = CARTESIAN_POINT('',(0.,8.,16.));
#133 = VECTOR('',#134,1.);
#134 = DIRECTION('',(1.,0.,-0.));
#135 = ORIENTED_EDGE('',*,*,#79,.F.);
#136 = PLANE('',#137);
#137 = AXIS2_PLACEMENT_3D('',#138,#139,#140);
#138 = CARTESIAN_POINT('',(0.,8.,0.));
#139 = DIRECTION('',(-0.,1.,0.));
#140 = DIRECTION('',(0.,0.,1.));
...
def test_roundtrip():
    with open('cuboid001_tmp.step','w') as f:
        f.write(instep)

    A=ab.Assembly(['cuboid001_tmp.step'])
    A.run(backend='stl2',h5m_filename='cuboid001_tmp.h5m')
    assert pl.Path('cuboid001_tmp.h5m').exists()

    try:
        import h5py
        f0=h5py.File('cuboid001_tmp.h5m')
